...
var CFormSelect = (0, import_react65.forwardRef)((_a, ref) => {
  ...
  return import_react65.default.createElement(
    ...
    import_react65.default.createElement("select", Object.assign({ id, className: classNames("form-select", {
      ...
      return import_react65.default.createElement("option", Object.assign({}, typeof option === "object" && option.disabled && { disabled: option.disabled }, typeof option === "object" && option.value !== void 0 && { value: option.value }, { key: index }), typeof option === "string" ? option : option.label);
    }) : children)
  );
});
